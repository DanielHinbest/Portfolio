        ...
        return (
            <div className="row">
                ...
                throughout the year and works to help shape the future of the program with input from students, alumni, faculty, and industry leaders."/>
                        ...
                        <About sectionTitle="My Work Experience" imagePath={process.env.PUBLIC_URL + "/images/work.png"} paragraph="In August 2022, I started working as an IT Developer at Scotiabank. I primarily
                        am working in the mainframe systems. From May 2021 to August 2021, I worked in my first position in the IT Industry
